...
class AliSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        if self.episode_title == "":
            ...
            file_path = episode_path+"/第" + \
                str(self.episode_no) + "话 - " + self.episode_title+".txt"
        ...
        for item in danmu:
            ...
            danmu['send_time'] = datetime.datetime.fromtimestamp(
                danmu['send_time'])
        ...
        es.update(index="fanju", doc_type="fanju",
                  id=self.episode_doc_id, body=updateDate)

        fanju = es.search(index="fanju", doc_type="fanju",
                          q="doc_type:fanju && ssid:"+str(self.ssid))
        ...
        if fanju['hits']['total'] > 0:
            ...
            es.update(index="fanju", doc_type="fanju",
                      id=fanju_doc_id, body=updateDate)
